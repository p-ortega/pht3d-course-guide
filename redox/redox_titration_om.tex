...
\item For which reactions are there qualitative changes in the $H^+$
stoichiometry (influence of pH) when the overall reaction 
is considered as compared to the half reaction ?

\item What quantitative differences are there in the
...
\item Calculate the number of umoles of $C_6H_6$ required to deplete 
