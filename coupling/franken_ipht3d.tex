...
\item Under {\color{blue}Parameters} $\rightarrow$ {\color{blue}Model} select the {\color{blue}Model} button and specify the attributes of the new model. Select the values {\color{blue}Xsection} for {\color{blue}Dimension}, {\color{blue}free} for {\color{blue}Type} 
