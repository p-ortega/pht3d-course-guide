...
{\color{blue} ph.5 Recharge} and set {\color{blue}Backg.} to 1.  
...
The input allows to activate mineral phases 
and to define values for the saturation index (SI) to which the mineral should be equilibrated (typically 0).
and the initial concentration {\color{blue}(Backgr\_SI} and {\color{blue}Backgr\_Mol}, respectively.
Leave the {\color{blue}Backgr\_SI} at the default value of 0 and define a background 
